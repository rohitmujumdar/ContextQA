...
from general_utils_with_meta import find_best_score_and_thresh, BatchGen_QuAC
...
def main():
    ...
    if args.resume:
        ...
        for batch in batches:
            phrases, noans, yesnos, followups = model.predict(batch)
...
def load_train_data(opt):
    ...
    with open(os.path.join(args.train_dir, 'train_data_with_meta.msgpack'), 'rb') as f:
